...
VOID CCodeTransfer::Hook()
{
	...
	MyTools::CCharacter::WriteDWORD(”Œœ∑ºÏ≤‚ª˘÷∑, 0);
...
{
	static DWORD dwAddr = ª÷∏¥VirtualProtect - NTDLLµÿ÷∑ + reinterpret_cast<DWORD>(::GetModuleHandleW(L"ntdll.dll"));
	return dwAddr;
}
